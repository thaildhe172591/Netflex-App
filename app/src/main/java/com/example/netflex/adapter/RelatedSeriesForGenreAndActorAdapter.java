...
public class RelatedSeriesForGenreAndActorAdapter extends RecyclerView.Adapter<RelatedSeriesForGenreAndActorAdapter.MovieViewHolder> {

    private List<Serie> movies = new ArrayList<>();
    ...
    public void setOnMovieClickListener(OnSerieClickListener listener) {
        this.listener = listener;
    }

    public RelatedSeriesForGenreAndActorAdapter(Context context) {
        this.context = context;
    }

    public void setMovies(List<Serie> list) {
        this.movies = list;
    ...
    public void onBindViewHolder(@NonNull MovieViewHolder holder, int position) {
        Serie movie = movies.get(position);

        String formattedDate = formatDate(movie.getFirstAirDate());
        String info = formattedDate + " | " + movie.getCountryIso();
